...
<footer class="bg-dark position-relative pt-6 pt-lg-8" data-bs-theme="dark">
    ...
    <div class="position-absolute top-0 end-0 mt-n8 z-index-9 d-none d-md-block">
        <img src="/images/elements/grad-shape/06.png" class="w-250px" alt="Shape">
    </div>
    ...
    <div class="container position-relative">
        <div class="row mb-4 mb-lg-7">
            ...
            <div class="col-lg-3 col-xl-4 mb-4 mb-lg-0">
                <!-- logo -->
                <a class="me-0" href="{{ route('any', 'index') }}">
            ...
            <div class="col-lg-9 col-xl-7 ms-md-auto">
                <div class="bg-white d-md-flex justify-content-between align-items-center rounded-4 p-4"
                    ...
                    <h5 class="mb-3 mb-md-0"><span class="hand-wave-animate">🖐️</span> Let's innovate together
                    </h5>
                    <a href="{{ route('second', [ 'pages' , 'contact-us-v1']) }}" class="btn btn-sm btn-primary-grad text-nowrap mb-0">Start
                        innovating</a>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <ul class="nav flex-column gap-1">
                            <li class="nav-item"><a class="nav-link pt-0" href="{{ route('second', [ 'about' , 'v1']) }}">About us</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('second', [ 'pages' , 'contact-us-v1']) }}">Contact us</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('second', [ 'about' , 'career']) }}">Career <span
                                        class="badge text-bg-success ms-2">We are hiring!</span></a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('second', [ 'about' , 'career-single']) }}">Career detail</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('second', [ 'pages' , 'contact-us-v2']) }}">Become a
                                    partner</a></li>
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <ul class="nav flex-column gap-1">
                            <li class="nav-item"><a class="nav-link pt-0" href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}">Case
                                    studies</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('second', [ 'pages' , 'pricing-v1']) }}">Pricing</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('third', [ 'pages' , 'blog','minimal']) }}">Blogs</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('third', [ 'pages' , 'blog','single']) }}">Blog detail</a>
                            </li>
            ...
            <div class="col-xl-4 mt-6 mt-xl-0">
                ...
                <div class="row g-2 mt-2 mb-4 mb-sm-5">
                    ...
                    <div class="col-5 col-sm-3 col-lg-2 col-xl-4">
                        <a href="#"> <img src="/images/elements/google-play.svg" alt="">
                        </a>
                    </div>
                    <!-- App store button -->
                    <div class="col-5 col-sm-3 col-lg-2 col-xl-4">
                        <a href="#"> <img src="/images/elements/app-store.svg" alt="app-store">
                        </a>
                    </div>
                </div>
            </div>
