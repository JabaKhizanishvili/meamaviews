            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5 position-relative">
                    ...
                    <div
                        ...
                        <!-- Title -->
                        <h1 class="mb-2 h3 fw-bold">Create Account</h1>
                        <p class="mb-0">Already have an account?<a
                                href="{{ route('third', ['pages', 'auth', 'sign-in']) }}" class="text-primary-grad">
                                Sign in here</a></p>
                        <!-- Form START -->
                        <form class="mt-2 mt-sm-4">
                            ...
                            <!-- Button -->
                            <div class="d-grid"><button type="submit" class="btn btn-primary">Create an
                                    account</button></div>
