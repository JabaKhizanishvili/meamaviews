                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-3 mb-5 mb-xl-0">
                        <div class="card shadow overflow-hidden p-1">
                            ...
                            <div class="card-header bg-secondary bg-opacity-50 p-4 pb-0">
                                ...
                                <p class="mb-0"> <span class="h2 mb-0 plan-price" data-monthly-price="$25"
                                        data-annual-price="$20">$25</span> /month</p>
                    ...
                    <div class="col-md-6 col-xl-3 mb-5 mb-xl-0">
                        <div class="card shadow overflow-hidden p-1">
                            ...
                            <div class="card-header bg-secondary bg-opacity-50 p-4 pb-0">
                                ...
                                <p class="mb-0"> <span class="h2 mb-0 plan-price" data-monthly-price="$59"
                                        data-annual-price="$45">$59</span> /month</p>
                            ...
                            <div class="card-footer bg-secondary bg-opacity-50 p-4">
                                ...
                                <ul class="list-group list-group-borderless mb-0">
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Up to 20 users monthly</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Free 12 host domain</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Google docs style editors</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Support for 30+ languages</li>
                                    ...
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Customizable features</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-5 mb-xl-0">
                        <div class="card shadow p-1">
                            ...
                            <div class="card-header bg-secondary-grad rounded-top p-4 pb-0">
                                ...
                                <p class="mb-0"> <span class="h2 mb-0 plan-price" data-monthly-price="$99"
                                        data-annual-price="$75">$99</span> /month</p>
                            ...
                            <div class="card-footer bg-secondary-grad p-4">
                                ...
                                <ul class="list-group list-group-borderless mb-0">
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Up to 50 users monthly</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Free 25 host domain</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Google docs style editors</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Support for 30+ languages</li>
                    ...
                    <div class="col-md-6 col-xl-3 mb-5 mb-xl-0">
                        <div class="card shadow overflow-hidden p-1">
                            <!-- Card header -->
                            <div
                                class="card-header bg-secondary bg-opacity-50 position-relative overflow-hidden p-4 pb-0">
                                <!-- Blur decoration -->
                                <div class="position-absolute top-0 end-0 mt-n8 me-n5">
                                    <img src="/images/elements/grad-shape/blur-decoration.svg"
                            ...
                            <div class="card-footer bg-secondary bg-opacity-50 p-4">
                                ...
                                <ul class="list-group list-group-borderless mb-0">
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Unlimited projects</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Custom reporting and analytics
                                    </li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Dedicated account manager</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Tailored support and
                                        consulting</li>
                                    <li class="list-group-item d-flex heading-color mb-0"><i
                                            class="bi bi-check-lg text-primary me-1"></i>Customizable features</li>
                                </ul>
            ...
            <div class="table-responsive-xl mt-2 mt-md-5">
                <table class="table table-striped table-borderless align-middle">
                    ...
                    <tbody class="border-top-0">
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Storage space</span>
                            </th>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Cloud
                                    connected</span></th>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Coding tools</span>
                            </th>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Advance
                                    debugging</span></th>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Mobile apps</span>
                            </th>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Web tools</span>
                            </th>
                            <td class="text-center text-danger"> <i class="bi bi-x-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i></td>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Version
                                    control</span></th>
                            <td class="text-center text-danger"> <i class="bi bi-x-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
                        ...
                        <!-- Item -->
                        <tr>
                            <th scope="row"><span class="fw-normal heading-color ps-lg-4 mb-0">Team access</span>
                            </th>
                            <td class="text-center text-danger"> <i class="bi bi-x-circle fa-lg"></i> </td>
                            <td class="text-center text-danger"> <i class="bi bi-x-circle fa-lg"></i> </td>
                            <td class="text-center text-success"> <i class="bi bi-check-circle fa-lg"></i> </td>
					...
					"breakpoints": {
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/01.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/01.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/01.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/02.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/02.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/02.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/03.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/03.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/03.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/04.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/04.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/04.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/05.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/05.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/05.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="swap-logo">
                                    <img src="/images/client/logo-gray/06.svg" class="p-2 p-lg-3" alt="client-img">
                                    <div class="swap-item">
                                        <img src="/images/client/logo-light/06.svg" class="dark-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                        <img src="/images/client/logo-dark/06.svg" class="light-mode-item p-2 p-lg-3"
                                            alt="client logo">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <!-- CTA text -->
                    <p class="heading-color text-center">Need help? Our team is ready to assist you. Start a chat for
