...
@section('content')
    ...
    <main>
        ...
        <section class="pt-xl-8">
            <!-- Title and content -->
            <div class="container inner-container pt-4 pt-md-5">
                <!-- Breadcrumb -->
                <nav class="mb-2 justify-content-center d-flex" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('third', ['pages', 'saas', 'integrations']) }}">Integration</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Integration single</li>
                    </ol>
                </nav>

                <!-- Main title -->
                <div class="bg-secondary rounded-4 d-sm-flex align-items-center p-4 p-sm-5 mb-5 mb-sm-7">
                    <!-- Icon -->
                    <div class="icon-xxl text-center shadow-primary bg-body rounded-3 flex-shrink-0">
                        <img src="/images/client/icons/05.svg" class="h-60px" alt="">
                    </div>
                    <div class="ms-sm-4 mt-3 mt-sm-0">
                        <h1 class="h3 mb-1">Connect with Graphlo</h1>
                        <span>Expert data synchronization for reliable transfer between your application and external
                            systems</span>
                    </div>
                </div>
                ...
                <p>Integrating with Folio is a game-changer. With this integration, you can effortlessly synchronize data,
                    messages, and tasks between our software and Folio. Enjoy real-time updates, improved communication, and
                    a more organized workflow.</p>
                <p>How promotion excellent curiosity yet attempted happiness Gay prosperous impression had conviction For
                    every delay death ask style Me mean able.</p>

                <h6 class="mb-3 mt-4">step:1 Access master Dashboard</h6>
                <p>With this integration, you can effortlessly synchronize data, messages, and tasks between our software
                    and Folio. Enjoy real-time updates, improved communication, and a more organized workflow.</p>
                <ul class="list-group list-group-borderless">
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>Receive instant notifications in Folio whenever there's an
                        update or action in Graphlo
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>Effortlessly create, assign, and manage tasks in both
                        platforms, ensuring nothing falls through the cracks.
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>Keep all your data consistent and up to date, whether it's
                        customer information, project details, or important messages.
                    </li>
                </ul>

                <h6 class="mb-3 mt-4">Step 2: Generate integration token</h6>
                <p>With this integration, you can effortlessly synchronize data, messages, and tasks between our software
                    and Folio. Enjoy real-time updates, improved communication, and a more organized workflow.</p>
                <ul class="list-group list-group-borderless">
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>In the Graphlo dashboard, navigate to the "Integrations" or
                        "API Settings" section, usually located in the settings menu
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>Locate the option to generate an integration token and follow
                        the provided instructions.
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>This token will serve as the authentication mechanism between
                        your SaaS application and Graphlo.
                    </li>
                </ul>

                <h6 class="mb-3 mt-4">Step 3: Map data fields</h6>
                <ul class="list-group list-group-borderless">
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>After configuring the integration, you'll need to map the
                        relevant data fields between your SaaS application and Graphlo.
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>This mapping ensures that the data exchanged between the two
                        platforms is correctly synchronized.
                    </li>
                    <li class="list-group-item heading-color d-flex mb-0">
                        <i class="bi bi-arrow-right me-2"></i>Common data fields to map may include customer information,
                        product details, orders, and inventory levels.
                    </li>
                </ul>
                <!-- Detail END -->
            </div>
