...
<main>
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-md-4">
                    <div class="card bg-secondary rounded-4 p-4 h-100">
                        ...
                        <div class="card-body p-0">
                            <!-- Icon -->
                            <div class="icon-lg bg-pink text-white rounded-circle mb-3"><i class="bi bi-telephone"></i>
                            </div>
                            <h6>Call us</h6>
                ...
                <div class="col-md-4">
                    <div class="card bg-secondary rounded-4 p-4 h-100">
                        ...
                        <div class="card-body p-0">
                            <!-- Icon -->
                            <div class="icon-lg bg-primary text-white rounded-circle mb-3"><i
                ...
                <div class="col-md-4">
                    <div class="card bg-secondary rounded-4 p-4 h-100">
                        ...
                        <div class="card-body p-0">
                            <!-- Icon -->
                            <div class="icon-lg bg-warning text-white rounded-circle mb-3"><i class="bi bi-headset"></i>
                            </div>
                            <h6>Support</h6>
                        ...
                        <!-- Card footer -->
                        <div class="card-footer bg-transparent p-0 pt-3">
                            <a class="btn btn-sm btn-white-shadow icon-link icon-link-hover" href="#">Chat now<i
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck1">I agree that my data is <a
                                    href="#" class=" hover-underline-animation text-primary-hover">collected and
                                    stored</a>.</label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 d-sm-flex align-items-center gap-3 mt-4">
                        ...
                        <ul class="list-inline mb-0 ms-auto">
                            ...
                            <li class="list-inline-item"> <a href="#"
                                    class="heading-color text-primary-hover"><i class="bi bi-facebook"></i></a> </li>
                            <li class="list-inline-item"> <a href="#"
                                    class="heading-color text-primary-hover"><i class="bi bi-instagram"></i></a> </li>
                            <li class="list-inline-item"> <a href="#"
                                    class="heading-color text-primary-hover"><i class="bi bi-twitter-x"></i></a> </li>
                            <li class="list-inline-item"> <a href="#"
                                    class="heading-color text-primary-hover"><i class="bi bi-linkedin"></i></a> </li>
                        </ul>
                    </div>
                </form>
                <!-- Form END -->
    ...
    <section class="position-relative pt-0 overflow-hidden">
        ...
        <div class="position-absolute bottom-0 end-0 mb-n3 me-n7 d-none d-xl-block">
            <img src="/images/elements/relex-slay.png" class="h-400px h-xxl-500px rtl-flip" alt="image">
        </div>
