...
@section('css')
@vite(['node_modules/swiper/swiper-bundle.min.css', 'node_modules/aos/dist/aos.css'])
@endsection
...
<ul class="nav align-items-center dropdown-hover ms-sm-2">
    ...
    <li class="nav-item ms-2 d-none d-sm-block">
        <a href="#" class="btn btn-sm btn-dark mb-0"><i class="bi bi-cloud-download-fill me-2"></i>Download
            app</a>
    </li>
...
<main>
    ...
    <section class="position-relative overflow-hidden pt-sm-8 pt-lg-9 pb-0">
        <!-- Curve bg -->
        <span>
            <svg class="position-absolute bottom-0 start-0 mb-n1 mb-lg-n4" viewBox="0 0 1920 149"
                style="enable-background:new 0 0 1920 149; z-index: 4" xml:space="preserve">
                <path class="text-secondary"
                    d="M873.3,37.9C775,19.2,603.7-11.5,433.5,4.4C275.1,19.3,45.1,43.4-12,4.4v121V149l1946-2.6V97.6 c-109.9-35.9-230.6-93.1-468.8-75.4C1260.2,37.3,1089.7,79,873.3,37.9z"
                    fill="currentColor" />
            </svg>
        </span>
        ...
        <div class="container position-relative pt-4 pt-sm-0 pb-8 pb-xl-9">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-6 mb-lg-0">
                    ...
                    <p class="lead mb-3 mb-md-4">Experience seamless money transfers, hassle-free bill payments, and
                        secure account management—all in one app.</p>

                    <!-- Buttons -->
                    <div class="d-sm-flex mb-4 mb-lg-7">
                        <a href="#"> <img src="/images/elements/google-play.svg"
                                class="btn-transition me-4 mb-2 mb-sm-0" width="180" alt="play store"> </a>
                        <a href="#"> <img src="/images/elements/app-store.svg" class="btn-transition"
                                width="180" alt="app-store"> </a>
                    </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <p class="heading-color mb-0"><span class="text-primary">5000+</span> users have downloaded
                            our app</p>
                    </div>
                </div>
                ...
                <div class="col-sm-9 col-lg-5 col-xxl-4 position-relative mx-auto">
                    ...
                    <div class="position-absolute start-0 top-0 mt-6 ms-xl-n7 z-index-2 d-none d-sm-block">
                        <img src="/images/mobile-app/deocration-2.jpg" class="aos rounded-3 shadow-primary"
                            data-aos="zoom-in" data-aos-delay="400" data-aos-duration="800"
                            data-aos-easing="ease-in-out" style="height: 80px;" alt="deocration">
                    </div>

                    <div
                        class="position-absolute top-50 end-0 translate-middle-y me-n6 me-xl-n8 mt-xl-n5 d-none d-sm-block">
                        <img src="/images/mobile-app/deocration-3.jpg" class="aos rounded-3 shadow-primary"
                            data-aos="zoom-in" data-aos-delay="600" data-aos-duration="800"
                            data-aos-easing="ease-in-out" alt="deocration">
                    </div>

                    <!-- Main image -->
                    <img src="/images/mobile-app/hero.png" class="aos mb-n8 mb-md-n9 mb-xxl-n8" data-aos="fade-up"
        ...
        <div class="container">
            ...
            <div class="row g-4 g-lg-5 align-items-lg-center">
                ...
                <div class="col-md-8 col-lg-4 mx-auto order-3 order-lg-2">
                    <img src="/images/mobile-app/feature.png" class="aos" data-aos="fade-up" data-aos-delay="100"
                        data-aos-duration="1000" data-aos-easing="ease-in-out" alt="feature mobile">
                </div>
            ...
            <div class="inner-container row g-4 mt-6 mt-md-8" data-aos="zoom-in" data-aos-delay="100"
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="text-center border-end pe-sm-5 h-100">
                        <img src="/images/elements/review.svg" class="h-60px mb-4" alt="review image">
                        <h4>4.5/5.0</h4>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="text-center border-end pe-sm-5 h-100">
                        <div class="d-flex justify-content-center gap-2 mb-4">
                            <img src="/images/elements/apple.svg" class="h-60px" alt="">
                            <img src="/images/elements/play-store.svg" class="h-60px" alt="">
                        </div>
                        <h4>35K+</h4>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-body">
                                <div class="bg-secondary-grad rounded-4 overflow-hidden p-5 h-100">
                                    <img src="/images/mobile-app/step-1.jpg" class="mb-n8 rounded-5 shadow-primary"
                                        alt="step image">
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-body">
                                <div class="bg-secondary-grad rounded-4 overflow-hidden p-5 h-100">
                                    <img src="/images/mobile-app/step-2.jpg" class="mb-n8 rounded-5 shadow-primary"
                                        alt="step image">
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-body">
                                <div class="bg-secondary-grad rounded-4 overflow-hidden p-5 h-100">
                                    <img src="/images/mobile-app/step-3.jpg" class="mb-n8 rounded-5 shadow-primary"
                                        alt="step image">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper mb-lg-5">
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="mb-0">Create an account using your email or phone number. Complete the
                                    straightforward verification process to ensure your account is protected. Follow the
                                    simple verification process to secure your account. This ensures a personalized and
                                    seamless banking experience.</p>
                            </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="mb-0">Provide the necessary information to set up your profile. This
                                    ensures a personalized and seamless banking experience tailored to your needs. This
                                    ensures a personalized and seamless banking experience.</p>
                            </div>
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="mb-0">Discover all the app’s functionalities, from instant money transfers
                                    to convenient bill payments, and start managing your finances with ease and
                                    efficiency. This ensures a personalized and seamless banking experience. Follow the
                                    simple verification process to secure your account.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Slider END -->
            ...
            <div class="row align-items-lg-center">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-group list-group-borderless mb-0">
                        <li class="list-group-item d-flex fw-semibold pb-0"><i
                                class="bi bi-check-circle text-primary me-2"></i>Convenience at your fingertips</li>
                        <li class="list-group-item d-flex fw-semibold pb-0"><i
                                class="bi bi-check-circle text-primary me-2"></i>Enhanced security</li>
                        <li class="list-group-item d-flex fw-semibold pb-0"><i
                                class="bi bi-check-circle text-primary me-2"></i>Comprehensive financial tools</li>
                    </ul>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex align-items-center mb-4">
                                <div class="w-40px h-100 me-4 me-sm-5 flex-shrink-0">
                                    <div class="d-flex">
                                        <h4 class="purecounter mb-0" data-purecounter-start="0"
                                            data-purecounter-end="98" data-purecounter-delay="300">0</h4>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex align-items-center mb-4">
                                <div class="w-40px h-100 me-4 me-sm-5 flex-shrink-0">
                                    <div class="d-flex">
                                        <h4 class="purecounter mb-0" data-purecounter-start="0"
                                            data-purecounter-end="60" data-purecounter-delay="300">0</h4>
                ...
                <div class="col-md-6 col-lg-5 position-relative ms-auto">
                    <img src="/images/mobile-app/01.jpg" class="rounded-4" alt="feature image">
                    <!-- Rocket image -->
                    <div class="position-absolute start-0 top-0 ms-n6 d-none d-lg-block">
                        <img src="/images/elements/rocket-03.png" class="h-150px" alt="rocket image">
                    </div>
                    <!-- Decoration -->
                    <div class="position-absolute bottom-0 end-0 me-lg-n5 mb-lg-n3">
                        <img src="/images/mobile-app/deocration.jpg" class="shadow rounded-3 h-lg-70px"
        ...
        <div class="container-fluid position-relative">
            <div class="max-width-1550 bg-dark position-relative rounded-4 overflow-hidden py-6 py-lg-8">
                ...
                <div class="container inner-container-small text-center mb-7">
                    ...
                    <p class="mb-4"> Browse through our gallery to get a glimpse of the intuitive design and powerful
                        features that make managing your finances effortless.</p>
                    <div class="d-sm-flex justify-content-center">
                        <a href="#"> <img src="/images/elements/google-play.svg"
                                class="btn-transition me-sm-4 mb-2 mb-sm-0" width="180" alt="play store"> </a>
                        <a href="#"> <img src="/images/elements/app-store.svg" class="btn-transition"
                                width="180" alt="app-store"> </a>
                    </div>
                </div>
                ...
                <!-- Slider START -->
                <div class="swiper swiper-outside-n5 pb-6 mx-3 mx-sm-0"
                    data-swiper-options='{
				"slidesPerView": 1,
				"spaceBetween": 50,
				"autoplay":{
				...
				"pagination":{
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-01.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-02.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-03.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-04.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-05.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-06.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-07.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>

                        <!-- Image -->
                        <div class="swiper-slide">
                            <img src="/images/mobile-app/screen/s-08.jpg"
                                class="rounded-4 border border-secondary border-3" alt="mobile screen">
                        </div>
                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card bg-secondary bg-opacity-50 rounded-4 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <!-- Image -->
                                            <img src="/images/team/01.jpg" class="rounded-start mb-3 mb-md-0"
                                                alt="...">
                                        </div>
                                        <div class="col-md-7 col-xl-6">
                                            ...
                                            <div class="card-body d-flex flex-column h-100 p-xl-4">
                                                ...
                                                <p class="heading-color">I've been using this app for over a year now,
                                                    and it has made managing my finances so much easier. The user
                                                    interface is incredibly intuitive.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="card bg-secondary bg-opacity-50 rounded-4 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <!-- Image -->
                                            <img src="/images/team/04.jpg" class="rounded-start mb-3 mb-md-0"
                                                alt="...">
                                        </div>
                                        <div class="col-md-7 col-xl-6">
                                            <!-- Content -->
                                            <div class="card-body d-flex flex-column h-100 p-xl-4">
                                                ...
                                                <p class="heading-color">The app is fast, reliable, and customer
                                                    support is always there when I need help. Highly recommended!</p>
                            ...
                            <div class="swiper-slide">
                                <div class="card bg-secondary bg-opacity-50 rounded-4 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <!-- Image -->
                                            <img src="/images/team/03.jpg" class="rounded-start mb-3 mb-md-0"
                                                alt="...">
                                        </div>
                                        <div class="col-md-7 col-xl-6">
                                            <!-- Content -->
                                            <div class="card-body d-flex flex-column h-100 p-xl-4">
                                                ...
                                                <p class="heading-color">The budgeting tools in this app have helped me
                                                    save more and spend wisely.</p>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-4 col-lg-5 ms-auto">
                    <div class="d-flex justify-content-center justify-content-sm-end gap-3 position-relative mt-3">
                        <a href="#"
                            class="btn btn-secondary btn-lg btn-icon rounded-circle mb-0 swiper-button-prev"><i
                                class="bi bi-arrow-left"></i></a>
                        <a href="#"
                            class="btn btn-secondary btn-lg btn-icon rounded-circle mb-0 swiper-button-next"><i
                                class="bi bi-arrow-right"></i></a>
                    </div>
                </div>

                <!-- Blogs START -->
                <div class="swiper mt-0"
                    data-swiper-options='{
				"spaceBetween": 50,
				"loop": true,
				"autoplay":false,
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide py-4">
                            <article class="card card-img-scale shadow-sm rounded-4 overflow-hidden h-100">
                                ...
                                <div class="card-img-scale-wrapper">
                                    <img src="/images/blog/4by3/01.jpg" class="card-img-top img-scale"
                                        alt="Blog-img">
                                </div>
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <p class="mb-0">Learn essential tips to keep your online banking experience safe
                                        and secure.</p>
                                </div>
                        ...
                        <div class="swiper-slide py-4">
                            <article class="card card-img-scale shadow-sm rounded-4 overflow-hidden h-100">
                                ...
                                <!-- Card image -->
                                <div class="card-img-scale-wrapper">
                                    <img src="/images/blog/4by3/02.jpg" class="card-img-top img-scale"
                                        alt="Blog-img">
                                </div>
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <p class="mb-0">Explore the latest trends in digital banking and how they are
                        ...
                        <div class="swiper-slide py-4">
                            <article class="card card-img-scale shadow-sm rounded-4 overflow-hidden h-100">
                                ...
                                <!-- Card image -->
                                <div class="card-img-scale-wrapper">
                                    <img src="/images/blog/4by3/03.jpg" class="card-img-top img-scale"
                                        alt="Blog-img">
                                </div>
                                ...
                                <div class="card-body pb-2">
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">How to maximize your savings with our
                                            app</a></h6>
                                    <p class="mb-0">Discover practical strategies to save more money using the
                                        features of our app.</p>
                                </div>
                        ...
                        <div class="swiper-slide py-4">
                            <article class="card card-img-scale shadow-sm rounded-4 overflow-hidden h-100">
                                ...
                                <!-- Card image -->
                                <div class="card-img-scale-wrapper">
                                    <img src="/images/blog/4by3/04.jpg" class="card-img-top img-scale"
                                        alt="Blog-img">
                                </div>
                                ...
                                <div class="card-body pb-2">
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">Understanding mobile payment
                                            solutions</a></h6>
                                    <p class="mb-0"> Get a comprehensive overview of mobile payment solutions and how
                                        they work.</p>
                                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-4">Join the millions of users who are already enjoying a smarter, simpler, and more
                        secure way to manage their finances.</p>
                    <!-- Buttons -->
                    <div class="d-sm-flex">
                        <a href="#"> <img src="/images/elements/google-play.svg"
                                class="btn-transition me-4 mb-2 mb-sm-0" width="150" alt="play store"> </a>
                        <a href="#"> <img src="/images/elements/app-store.svg" class="btn-transition"
                                width="150" alt="app-store"> </a>
                    </div>
                </div>

                <!-- Image -->
                <div class="col-sm-9 col-md-6 mx-auto mb-n9">
                    <img src="/images/mobile-app/cta.png" class="aos mb-n5 mb-lg-n9 ms-lg-5" data-aos="fade-up"
                        data-aos-delay="200" data-aos-duration="500" data-aos-easing="ease-in-out" alt="cta image">
                </div>
            </div>
        </div>
    </section>
