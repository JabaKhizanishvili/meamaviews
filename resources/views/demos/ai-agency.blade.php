...
@section('css')
@vite(['node_modules/swiper/swiper-bundle.min.css', 'node_modules/glightbox/dist/css/glightbox.css', 'node_modules/aos/dist/aos.css'])
@endsection
...
<main>
        ...
        <div class="container position-relative pt-4 pt-md-0">
            <div class="row">
                ...
                <div class="col-md-7 col-lg-6 mb-5 mb-md-0">
                    <h1 class="display-5 mb-3 mb-md-4">Smart Solutions with <span class="text-primary">AI</span></h1>
                    <p class="lead mb-3 mb-md-4">Harness AI to unlock your business potential, streamline operations,
                        and drive growth.</p>
                    <a class="btn btn-primary-grad icon-link icon-link-hover" href="#">Get Started<i
                            class="bi bi-arrow-right"></i> </a>
                </div>

                <!-- Image -->
                <div class="col-md-5 ms-auto">
                    <img src="/images/elements/ai-robot.png" class="aos" data-aos="fade-up" data-aos-delay="200"
                        data-aos-duration="500" data-aos-easing="ease-in-out" alt="AI-robot">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-md-4 mb-4 mb-sm-0">
                    <div class="card card-body bg-transparent text-center p-0">
                        ...
                        <div
                            ...
                            <svg class="text-warning" width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Title and content -->
                        <h6 class="mb-3">Future-proof solutions</h6>
                        <p class="mb-0">Our AI solutions are designed with scalability in mind, allowing your
                            business to grow and adapt without the need.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-sm-0">
                    <div class="card card-body bg-transparent text-center p-0">
                        ...
                        <!-- Title and content -->
                        <h6 class="mb-3">Data security and compliance</h6>
                        <p class="mb-0">We ensure full compliance with industry standards, safeguarding your data at
                            all times.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-sm-0">
                    <div class="card card-body bg-transparent text-center p-0">
                        ...
                        <div
                            ...
                            <svg class="text-pink" width="50" height="50" viewBox="0 0 50 50" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- Title and content -->
                        <h6 class="mb-3">Effortless integration and support</h6>
                        <p class="mb-0">We prioritize seamless integration of our AI solutions into your existing
    ...
    <section class="position-relative pt-0 pb-0 pb-xl-8">
        <div class="container px-xl-7">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 position-relative pe-xl-6 mb-5 mb-lg-0">
                    ...
                    <img src="/images/about/07.jpg" class="rounded-4 z-index-2 position-relative" alt="about image">
                </div>
                ...
                <div class="col-lg-6 ms-auto">
                    ...
                    <div class="d-flex align-items-center" style="max-width: 30rem;">
                        <h2 class="display-4 text-primary-grad mb-0">14+</h2>
                        <h6 class="mb-0 ms-3">Products successfully launched</h6>
                    </div>
                    ...
                    <div class="nav nav-pills nav-pills-dark gap-3" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-mission-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true"><i class="bi bi-bullseye me-2"></i>Our Mission</button>
                        <button class="nav-link" id="nav-vision-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-vision" type="button" role="tab" aria-controls="nav-vision"
                            aria-selected="false"><i class="bi bi-eye me-2"></i>Our Vision</button>
                        <button class="nav-link" id="nav-goal-tab" data-bs-toggle="tab" data-bs-target="#nav-goal"
                            type="button" role="tab" aria-controls="nav-goal" aria-selected="false"><i
                                class="bi bi-trophy me-2"></i>Our Goal</button>
                    </div>
                    ...
                    <div class="tab-content mt-4" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="nav-mission" role="tabpanel"
                            ...
                            <p class="mb-2">We strive to be the trusted partner that helps our clients navigate the
                                complexities of the digital age with confidence and ease</p>
                            <!-- List -->
                            <ul class="list-group list-group-borderless mb-3">
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Advanced AI technology</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Boosting efficiency with
                                    optimized workflows</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Driving sustainable growth with
                                    insights</li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane fade" id="nav-vision" role="tabpanel" aria-labelledby="nav-vision-tab"
                            tabindex="0">
                            <p class="mb-2">Effective design communicates your brand's identity, cultivates trust,
                                and can significantly impact conversion rates and customer loyalty.</p>
                            <!-- List -->
                            <ul class="list-group list-group-borderless mb-3">
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Tailored solutions</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Proven track Record</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Cost-effectiveness</li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane fade" id="nav-goal" role="tabpanel" aria-labelledby="nav-goal-tab"
                            tabindex="0">
                            <p class="mb-2">We provide a range of tools, guides, and best practices to help you
                                create designs, websites.</p>
                            <!-- List -->
                            <ul class="list-group list-group-borderless mb-3">
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Digital pioneers</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Continuous learning</li>
                                <li class="list-group-item heading-color d-flex pb-0"><i
                                        class="bi bi-patch-check text-success me-2"></i>Inspiring transformation</li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="position-absolute top-100 start-0 translate-middle ms-9 mt-4 z-index-9 d-none d-xl-block">
            <img src="/images/elements/ai-hand.png" class="aos ms-9 ps-6" data-aos="fade-right" data-aos-delay="100"
                data-aos-duration="800" data-aos-easing="ease-in-out" alt="ai hand">
        </div>
    </section>
    <!-- =======================
        About END -->
    ...
    <section class="py-0 position-relative">
        ...
        <div class="position-absolute end-0 bottom-0 me-lg-7 mb-n7 z-index-2 d-none d-md-block">
            <img src="/images/elements/ai-robot-2.png" class="aos h-300px" data-aos="fade-left" data-aos-delay="100"
                data-aos-duration="800" data-aos-easing="ease-in-out" alt="robot image">
        </div>

        <div class="bg-dark position-relative overflow-hidden py-8">
            <!-- AI pattern -->
            <div class="position-absolute top-0 start-0 mt-n9">
                <img src="/images/elements/ai-pattern.png" class="mt-n7" alt="">
            </div>
            <!-- Curve bg -->
            ...
            <div class="container position-relative pt-5 pt-sm-8" data-bs-theme="dark">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h2 class="mb-3 mb-lg-4">AI solutions for every business</h2>
                        <p class="mb-3 mb-lg-4">Discover our AI services designed to optimize operations, enhance
                            decisions, and drive growth.</p>
                        <a href="{{ route('second', ['about', 'services-list']) }}" class="btn btn-primary">Explore
                            all services</a>
                    </div>
                    ...
                    <div class="col-lg-7 ms-auto hover-opacity-fade">
                        ...
                        <div class="hover-item d-flex align-items-center border-bottom position-relative py-4">
                            <!-- Icon -->
                            <img src="/images/services/geo-shape/01.svg" class="me-3" alt="service icon">
                            <h6 class="mb-0">AI consulting and strategy</h6>
                            <a href="{{ route('second', ['about', 'service-single']) }}"
                                class="icon-link icon-link-hover text-body stretched-link ms-auto"><i
                        ...
                        <div class="hover-item d-flex align-items-center border-bottom position-relative py-4">
                            <!-- Icon -->
                            <img src="/images/services/geo-shape/02.svg" class="me-3" alt="service icon">
                            <h6 class="mb-0">Natural language processing (NLP)</h6>
                            <a href="{{ route('second', ['about', 'service-single']) }}"
                                class="icon-link icon-link-hover text-body stretched-link ms-auto"><i
                                    class="bi bi-arrow-right fs-5"></i> </a>
                        </div>
                        ...
                        <div class="hover-item d-flex align-items-center border-bottom position-relative py-4">
                            <!-- Icon -->
                            <img src="/images/services/geo-shape/03.svg" class="me-3" alt="service icon">
                            <h6 class="mb-0">Custom AI development</h6>
                            <a href="{{ route('second', ['about', 'service-single']) }}"
                                class="icon-link icon-link-hover text-body stretched-link ms-auto"><i
                                    class="bi bi-arrow-right fs-5"></i> </a>
                        </div>
                        ...
                        <div class="hover-item d-flex align-items-center border-bottom position-relative py-4">
                            <!-- Icon -->
                            <img src="/images/services/geo-shape/04.svg" class="me-3" alt="service icon">
                            <h6 class="mb-0">AI-Powered automation</h6>
                            <a href="{{ route('second', ['about', 'service-single']) }}"
                                class="icon-link icon-link-hover text-body stretched-link ms-auto"><i
                                    class="bi bi-arrow-right fs-5"></i> </a>
                        </div>
                        ...
                        <div class="hover-item d-flex align-items-center border-bottom position-relative py-4">
                            <!-- Icon -->
                            <img src="/images/services/geo-shape/05.svg" class="me-3" alt="service icon">
                            <h6 class="mb-0">Computer vision solutions</h6>
                            <a href="{{ route('second', ['about', 'service-single']) }}"
                                class="icon-link icon-link-hover text-body stretched-link ms-auto"><i
                                    class="bi bi-arrow-right fs-5"></i> </a>
                        </div>
                ...
                <div class="inner-container text-center mt-8">
                    ...
                    <!-- Button -->
                    <a class="btn btn-outline-secondary icon-link icon-link-hover" href="#">Uncover our AI
                        capabilities<i class="bi bi-arrow-right"></i> </a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="overflow-hidden">
        <div class="container mb-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-5">
                    <h2 class="text-center text-sm-start mb-0">Success stories and projects</h2>
                </div>
                ...
                <div class="col-sm-4 col-lg-5 ms-auto">
                    <div class="d-flex justify-content-center justify-content-sm-end gap-3 position-relative mt-3">
                        <a href="#"
                            class="btn btn-secondary btn-lg btn-icon rounded-circle mb-0 swiper-button-prev-project rtl-flip"><i
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card card-img-scale card-content-hover card-metro-hover rounded-4">
                        ...
                        <div class="card-img-overlay hover-content d-flex flex-column align-items-start p-5">
                            <!-- Client logo -->
                            <img src="/images/client/logo-light/05.svg" class="h-30px" alt="client logo">
                            <!-- Title -->
                            <div class="card-text mt-auto">
                                <h6 class="mb-0"><a href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}"
                                        class="text-white stretched-link">AI-Driven customer insights platform</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card card-img-scale card-content-hover card-metro-hover rounded-4">
                        ...
                        <div class="card-img-overlay hover-content d-flex flex-column align-items-start p-5">
                            <!-- Client logo -->
                            <img src="/images/client/logo-light/06.svg" class="h-30px" alt="client logo">
                            <!-- Title -->
                            <div class="card-text mt-auto">
                                <h6 class="mb-0"><a href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}"
                                        class="text-white stretched-link">Automated customer support with NLP</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card card-img-scale card-content-hover card-metro-hover rounded-4">
                        ...
                        <div class="card-img-overlay hover-content d-flex flex-column align-items-start p-5">
                            <!-- Client logo -->
                            <img src="/images/client/logo-light/08.svg" class="h-30px" alt="client logo">
                            <!-- Title -->
                            <div class="card-text mt-auto">
                                <h6 class="mb-0"><a href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}"
                                        class="text-white stretched-link">Smart inventory management for retail</a>
                                </h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="card card-img-scale card-content-hover card-metro-hover rounded-4">
                        <!-- Card Image -->
                        <img src="/images/portfolio/4by4/04.jpg" class="img-scale" alt="portfolio-img">

                        <!-- Card elements -->
                        <div class="card-img-overlay hover-content d-flex flex-column align-items-start p-5">
                            <!-- Client logo -->
                            <img src="/images/client/logo-light/02.svg" class="h-30px" alt="client logo">
                            <!-- Title -->
                            <div class="card-text mt-auto">
                                <h6 class="mb-0"><a href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}"
                                        class="text-white stretched-link">AI-powered fraud detection </a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="card card-img-scale card-content-hover card-metro-hover rounded-4">
                        ...
                        <div class="card-img-overlay hover-content d-flex flex-column align-items-start p-5">
                            <!-- Client logo -->
                            <img src="/images/client/logo-light/03.svg" class="h-30px" alt="client logo">
                            <!-- Title -->
                            <div class="card-text mt-auto">
                                <h6 class="mb-0"><a href="{{ route('second', [ 'portfolio' ,'case-study-v1']) }}"
                                        class="text-white stretched-link">AI-Driven customer insights platform</a></h6>
        ...
        <div class="inner-container-small bg-primary-grad rounded-3 text-center py-3 mt-6 mx-3 mx-md-auto">
            <p class="text-white mb-0 px-2 px-sm-5 px-md-0">🔥 Kickstart your project! collaborate with us for success!
                <a href="{{ route('second', [ 'pages' , 'contact-us-v1']) }}" class="fw-semibold hover-underline-animation text-white">Start today</a>
            </p>
        </div>
    </section>
    <!-- =======================
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="d-flex justify-content-between">
                        <div class="text-center">
                            ...
                            <!-- Content -->
                            <p class="px-3 py-2 bg-body mt-n3 mt-md-n4 position-relative">Total projects completed</p>
                        </div>

                        <div class="vr bg-primary-grad opacity-1 my-3"></div> <!-- Divider -->
                    </div>
                </div>
                ...
                <div class="col-md-4 text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <h4 class="purecounter display-2 mb-0" data-purecounter-start="0" data-purecounter-end="35"
                            data-purecounter-delay="300">0</h4>
                        <span class="display-2 text-purple mb-0">+</span>
                    </div>
                    <!-- Content -->
                    <p class="px-3 py-2 bg-body mt-n3 mt-md-n4 position-relative">Awards and accolades</p>
                </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                ...
                                <h4 class="purecounter display-2 mb-0" data-purecounter-start="0"
                                    data-purecounter-end="10" data-purecounter-delay="300">0</h4>
                                <span class="display-2 text-pink mb-0">K</span>
                            </div>
                            <!-- Content -->
                            <p class="px-3 py-2 bg-body mt-n3 mt-md-n4 position-relative">Satisfied users</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-0">
        <div class="container position-relative">
            ...
            <div
                ...
                <img class="avatar-img rounded-circle position-relative" src="/images/avatar/03.jpg" alt="avatar">
            </div>
                ...
                <div class="row position-relative">
                    <div class="col-md-8 mx-auto">
						...
						"pagination":{
                            ...
                            <div class="swiper-wrapper mb-5">
                                ...
                                <div class="swiper-slide">
                                    <div class="text-center">
                                        ...
                                        <blockquote class="mb-4">
                                            <p class="fs-6 heading-color mb-0">Our passion for customer excellence is
                                                just one reason why we are the market leader. We've always worked very
                                                hard to give our customers the best experience. Was out laughter
                                                raptures returned outweigh. Luckily cheered colonel I do we attack
                                                highest enabled. </p>
                                        </blockquote>
                                        <!-- Testimonials info -->
                                        <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="text-center">
                                        ...
                                        <!-- Testimonials text -->
                                        <blockquote class="mb-4">
                                            <p class="fs-6 heading-color mb-0">Their team went above and beyond to
                                                understand our needs and deliver a solution that exceeded our
                                ...
                                <div class="swiper-slide">
                                    <div class="text-center">
                                        ...
                                        <!-- Testimonials text -->
                                        <blockquote class="mb-4">
                                            <p class="fs-6 heading-color mb-0">Was out laughter raptures returned
                                                outweigh. Luckily cheered colonel I do we attack highest enabled. Tried
                                                law yet style child. The bore of true of no be deal.</p>
                                        </blockquote>
                                        <!-- Testimonials info -->
                                        <div>
                            ...
                            <!-- Slider Pagination -->
                            <div class="swiper-pagination swiper-pagination-primary position-absolute bottom-0 mb-3">
                            </div>
                        </div>
                        <!-- Slider END -->
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-4 mb-sm-5 mb-lg-0">
                    <h2 class="mb-3 mb-lg-4">Solutions we've built for...</h2>
                    <p class="mb-3 mb-lg-4">Our AI solutions have driven innovation, streamlined operations, and fueled
                        exceptional business growth.</p>
                    <a class="btn btn-primary icon-link icon-link-hover" href="#">Become a client<i
                            class="bi bi-arrow-right"></i> </a>
                </div>
                    ...
                    <div class="row border-md-transparent g-0">
                        ...
                        <div class="col-6 col-md-4 border-primary border-opacity-10 border-end border-bottom">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/03.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/03.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                        <!-- Client item -->
                        <div class="col-6 col-md-4 border-primary border-opacity-10 border-end border-bottom">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/08.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/08.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                        <!-- Client item -->
                        <div class="col-6 col-md-4 border-primary border-opacity-10 border-bottom">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/09.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/09.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                        <!-- Client item -->
                        <div class="col-6 col-md-4 border-primary border-opacity-10 border-end">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/02.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/02.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                        <!-- Client item -->
                        <div class="col-6 col-md-4 border-primary border-opacity-10 border-end">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/10.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/10.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                        <!-- Client item -->
                        <div class="col-6 col-md-4 border-primary border-opacity-10">
                            <div class="text-center p-3 p-md-5">
                                <img src="/images/client/logo-light/06.svg" class="dark-mode-item h-40px"
                                    alt="client logo">
                                <img src="/images/client/logo-dark/06.svg" class="light-mode-item h-40px"
                                    alt="client logo">
                            </div>
                        </div>
                    </div>
    ...
    <section class="position-relative py-0">
        ...
        <div class="position-absolute top-100 start-0 translate-middle ms-9 mt-n8 z-index-9 d-none d-lg-block">
            <img src="/images/elements/ai-robot-3.png" class="aos" data-aos="fade-up" data-aos-delay="100"
            ...
            <div class="container ps-lg-6 pt-6">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-9 col-xxl-4">
                        <h2 class="text-center text-sm-start">Our prestigious awards</h2>
                    </div>
                    ...
                    <div class="col-lg-9 col-xxl-8 d-sm-flex justify-content-sm-between ms-auto">
                        ...
                        <div class="card card-body bg-transparent text-center m-auto" style="max-width: 15rem;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img src="/images/elements/wing-1.svg" class="rtl-flip" alt="award wing">
                                <ul class="list-group list-group-borderless align-items-center">
                                    <li class="list-group-item fw-semibold heading-color d-flex pb-0">Best Website
                                        Award</li>
                                    <li class="list-group-item fw-semibold text-primary d-flex pb-0">2023</li>
                                </ul>
                                <img src="/images/elements/wing-2.svg" class="rtl-flip" alt="award wing">
                            </div>

                            <!-- Info -->
                            <span class="fw-semibold opacity-6">Accordion to</span>
                            <img src="/images/elements/clutch.svg" class="h-30px mt-2" alt="logo">
                        </div>
                        ...
                        <div class="card card-body bg-transparent text-center m-auto" style="max-width: 15rem;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img src="/images/elements/wing-1.svg" class="rtl-flip" alt="award wing">
                                <ul class="list-group list-group-borderless align-items-center">
                                    <li class="list-group-item fw-semibold heading-color d-flex pb-0">Digital Vanguard
                                        Award</li>
                                    <li class="list-group-item fw-semibold text-primary d-flex pb-0">2022</li>
                                </ul>
                                <img src="/images/elements/wing-2.svg" class="rtl-flip" alt="award wing">
                            </div>
                            ...
                            <!-- Info -->
                            <span class="fw-semibold opacity-6">Accordion to</span>
                            <img src="/images/elements/fwa.svg" class="h-30px mt-2" alt="logo">
                        </div>
                        ...
                        <div class="card card-body bg-transparent text-center m-auto" style="max-width: 15rem;">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img src="/images/elements/wing-1.svg" class="rtl-flip" alt="award wing">
                                <ul class="list-group list-group-borderless align-items-center">
                                    <li class="list-group-item fw-semibold heading-color d-flex pb-0">Website of the
                                        day</li>
                                    <li class="list-group-item fw-semibold text-primary d-flex pb-0">2021</li>
                                </ul>
                                <img src="/images/elements/wing-2.svg" class="rtl-flip" alt="award wing">
                            </div>
                            ...
                            <!-- Info -->
                            <span class="fw-semibold opacity-6">Accordion to</span>
                            <img src="/images/elements/dribbble.svg" class="h-30px mt-2" alt="logo">
                        </div>
                    </div>
                </div> <!-- Row END -->
            </div>
