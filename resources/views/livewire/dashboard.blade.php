                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">ბალანსი</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">ჯამური ნახვები</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{$user->getTotalViewsAttribute()}}
            ...
            <div class="col-lg-5 mb-lg-0 mb-4">
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        <h6 class="ms-2 mt-4 mb-0"> ვიდეოს ნახვები </h6>
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-header pb-0">
                        <h6>ვიდეოზე გამომუშავებული თანხა ნახვებთან მიმართებაში</h6>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-7">
                                ...
                                <p class="text-sm mb-0">
                                    ...
                                    <span class="font-weight-bold ms-1"> {{$user->videos->count()}} </span>                                 </p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">თემატიკა</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-center">ვიდეოს სახელი</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ვიდეოს ლინკი</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ნახვები</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">გამომუშავებული თანხა</th>
                                </tr>
                                </thead>
                                <tbody>
                                    @foreach($user->videos as $value)
                                <tr>
                                        <td>
...
{{--                                                </div>--}}
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{$value->theme->title}}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span class="text-xs font-weight-bold"> {{$value->title}} </span>
                                        </td>
                                        <td class="align-middle text-center text-sm"> <a href="{{$value->video_url}}" target="_blank">{{$value->video_url}}</a></td>
                                        <td class="align-middle text-center text-sm"> {{$value->views}}</td>
                                        <td class="align-middle text-center text-sm"> {{$value->earned_amount}}</td>
...
<script>
    ...
    const videoLabels = @json(array_column($user->videos->toArray(), 'title'));
    const videoViews = @json(array_column($user->videos->toArray(), 'views'));
    ...
    {{--const videoLabels = @json($user->videos->pluck('title'));--}}
    {{--const videoViews = @json($user->videos->pluck('views'));--}}
    const videoIncome = @json(array_column($user->videos->toArray(), 'earned_amount'));
{{--    const videoViews = @json(array_column($user->videos->toArray(), 'views'));--}}
